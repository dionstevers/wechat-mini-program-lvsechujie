...
exports.main = async (event, context) => {
  ...
  try {
    ...
    if (eventType === 'tap') {
      ...
      // Record visit open/close pair and accumulate reading time. The
      // article-read no longer awards coins (the 2-minute news-feed timer
      // owns the +88 reward via completeSession's COINS_EXIT_ENTRY).
